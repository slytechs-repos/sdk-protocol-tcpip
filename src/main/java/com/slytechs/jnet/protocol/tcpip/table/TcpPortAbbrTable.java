...
class TcpPortAbbrTable implements TableLookup {
	private final ResourceBundle defaultBundle;

	TcpPortAbbrTable() {
		this.defaultBundle = ResourceBundle.getBundle("tables.protocol.tcpip.tcp_port_abbr");
	}
	...
	public StringTableValue lookupString(String key, Locale locale) {
		...
		try {
			// Normalize key to tcp_port_abbr.0x#### format
			ResourceBundle bundle = ResourceBundle.getBundle("tables.protocol.tcpip.tcp_port_abbr", locale);
