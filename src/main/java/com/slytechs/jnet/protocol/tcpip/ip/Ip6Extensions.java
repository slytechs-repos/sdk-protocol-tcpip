...
/**
 * IPv6 extension headers container with zero-allocation inner extension classes.
 *
 * @author Mark Bednarczyk [mark@slytechs.com]
 * @author Sly Technologies Inc.
 * @since 1.0
 */
public final class Ip6Extensions extends ByteBuf implements HeaderExtensions<Ip6Extensions.Ip6Extension>, Detailable, Iterable<Ip6Extensions.Ip6Extension> {
    ...
    public final class HopByHop extends Ip6Extension {
        private HopByHop() { super(HOP_BY_HOP); }
    ...
    public final class Routing extends Ip6Extension {
        ...
        public byte[] address(int index) {
            if (!isPresent() || index < 0 || index >= addressCount()) return null;
    ...
    public final class Fragment extends Ip6Extension {
        private Fragment() { super(FRAGMENT); }
        ...
        public void buildDetail(DetailBuilder.HeaderBuilder h) {
            ...
            h.expandField("Offset/Flags", getShort(offset + 2) & 0xFFFF,
                    ...
                    shortAt(hdrOff + 2), f -> {
                        f.field("Fragment Offset", fragmentOffset(), fragmentOffsetBytes() + " bytes", bitsAt((hdrOff + 2) * 8L, 13));
                        f.field("Reserved", (getShort(offset + 2) >> 1) & 0x03, bitsAt((hdrOff + 2) * 8L + 13, 2));
                        f.field("More Fragments", moreFragments() ? 1 : 0, moreFragments() ? "Yes" : "No", bitsAt((hdrOff + 2) * 8L + 15, 1));
                    });
    ...
    public final class Destination extends Ip6Extension {
        private Destination() { super(DESTINATION); }
    ...
    public final class Authentication extends Ip6Extension {
        private Authentication() { super(AH); }
    ...
    public final class Mobility extends Ip6Extension {
        private Mobility() { super(MOBILITY); }
    ...
    public final class Experimental extends Ip6Extension {
        private Experimental(int id) { super(id); }
    ...
    public boolean hasHopByHopExtension() { return hopByHop.isPresent(); }
    public boolean hasRoutingExtension() { return routing.isPresent(); }
    public boolean hasFragmentExtension() { return fragment.isPresent(); }
    public boolean hasDestinationExtension() { return destination.isPresent(); }
    public boolean hasAuthenticationExtension() { return authentication.isPresent(); }
    public boolean hasEspExtension() { return esp.isPresent(); }
    public boolean hasMobilityExtension() { return mobility.isPresent(); }
    public boolean hasHipExtension() { return hip.isPresent(); }
    public boolean hasShim6Extension() { return shim6.isPresent(); }
    public boolean hasExperimental253Extension() { return experimental253.isPresent(); }
    public boolean hasExperimental254Extension() { return experimental254.isPresent(); }

    public boolean isFragmented() { return hasFragmentExtension(); }
    public boolean hasSecurityExtensions() { return hasAuthenticationExtension() || hasEspExtension(); }

    public HopByHop hopByHopExtension() { return hopByHop; }
    public Routing routingExtension() { return routing; }
    public Fragment fragmentExtension() { return fragment; }
    public Destination destinationExtension() { return destination; }
    public Authentication authenticationExtension() { return authentication; }
    public Esp espExtension() { return esp; }
    public Mobility mobilityExtension() { return mobility; }
    public Hip hipExtension() { return hip; }
    public Shim6 shim6Extension() { return shim6; }
    public Experimental experimental253Extension() { return experimental253; }
    public Experimental experimental254Extension() { return experimental254; }
    ...
    private void parse() {
        ...
        while (pos < end && chainLength < MAX_EXTENSIONS) {
            ...
            if (pos + 2 > end && extId != FRAGMENT) break;
            ...
            if (extLen < MIN_EXTENSION_LENGTH && extId != FRAGMENT) break;
    ...
    public boolean validateExtensions() {
        ...
        int fragmentCount = 0;
        for (int i = 0; i < chainLength; i++) {
            if (chain[i] == FRAGMENT) fragmentCount++;
        }
        if (fragmentCount > 1) return false;
    ...
    public void buildDetail(DetailBuilder b) {
        ...
        for (Ip6Extension ext : this) {
            ...
            b.header("IPv6 Extension - " + ext.extensionName(), ext.id, hdrOff, ext.length, ext::buildDetail);
        }
    }
