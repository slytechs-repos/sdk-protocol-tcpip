 ...
 */
public final class EspProtocol implements Protocol {

	private static final EspProtocol INSTANCE = new EspProtocol();
	public static final int ID = ProtocolIds.ESP;
	public static final String NAME = "ESP";
	public static final ProtocolPack PACK = TcpipPack.of();
	public static final HeaderFactory<Esp> FACTORY = Esp::new;

	public static EspProtocol of() {
		return INSTANCE;
	}
