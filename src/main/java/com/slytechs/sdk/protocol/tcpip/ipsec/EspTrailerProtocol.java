 ...
 */
public final class EspTrailerProtocol implements Protocol {

	private static final EspTrailerProtocol INSTANCE = new EspTrailerProtocol();
	public static final int ID = ProtocolIds.ESP_TRAILER;
	public static final String NAME = "ESP Trailer";
	public static final ProtocolPack PACK = TcpipPack.of();
	public static final HeaderFactory<EspTrailer> FACTORY = EspTrailer::new;

	public static EspTrailerProtocol of() {
		return INSTANCE;
	}

	private EspTrailerProtocol() {}
