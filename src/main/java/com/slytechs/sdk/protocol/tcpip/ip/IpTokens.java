 ...
 */
public class IpTokens implements TokenFactory {
	 ...
	 */
	@Override
	public IpToken newToken(long token, ByteBuffer b, int index) {
	 ...
	 */
	@Override
	public IpToken newToken(long token, MemorySegment seg, long offset) {
		throw new UnsupportedOperationException("not implemented yet");
	}
