 ...
 */
public final class Ip4Protocol implements Protocol {

	private static final Ip4Protocol INSTANCE = new Ip4Protocol();
	public static final int ID = ProtocolIds.IPv4;
	public static final String NAME = "IPv4";
	public static final ProtocolPack PACK = TcpipPack.of();
	public static final HeaderFactory<Ip4> FACTORY = Ip4::new;

	public static Ip4Protocol of() {
		return INSTANCE;
	}
