 ...
 */
public final class MplsProtocol implements Protocol {

	private static final MplsProtocol INSTANCE = new MplsProtocol();
	public static final int ID = ProtocolIds.MPLS;
	public static final String NAME = "MPLS";
	public static final ProtocolPack PACK = TcpipPack.of();
	public static final HeaderFactory<Mpls> FACTORY = Mpls::new;

	public static MplsProtocol of() {
		return INSTANCE;
	}

	private MplsProtocol() {}
