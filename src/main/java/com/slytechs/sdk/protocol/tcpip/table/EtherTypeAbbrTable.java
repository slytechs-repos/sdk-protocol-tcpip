...
class EtherTypeAbbrTable implements TableLookup {
    private final ResourceBundle defaultBundle;

    EtherTypeAbbrTable() {
        this.defaultBundle = ResourceBundle.getBundle("tables.protocol.tcpip.ether_type_abbr");
    }
    ...
    public StringTableValue lookupString(String key, Locale locale) {
        ...
        try {
            ...
            ResourceBundle bundle = ResourceBundle.getBundle("tables.protocol.tcpip.ether_type_abbr", locale);
