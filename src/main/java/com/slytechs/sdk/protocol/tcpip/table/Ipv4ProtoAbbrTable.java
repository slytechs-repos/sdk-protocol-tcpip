...
class Ipv4ProtoAbbrTable implements TableLookup {
	private final ResourceBundle defaultBundle;

	Ipv4ProtoAbbrTable() {
		this.defaultBundle = ResourceBundle.getBundle("tables.protocol.tcpip.ipv4_proto_abbr");
	}
	...
	public StringTableValue lookupString(String key, Locale locale) {
		...
		try {
			ResourceBundle bundle = ResourceBundle.getBundle("tables.protocol.tcpip.ipv4_proto_abbr", locale);
