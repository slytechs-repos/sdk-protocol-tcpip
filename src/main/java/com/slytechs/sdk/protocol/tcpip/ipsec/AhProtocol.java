 ...
 */
public final class AhProtocol implements Protocol {

	private static final AhProtocol INSTANCE = new AhProtocol();
	public static final int ID = ProtocolIds.AH;
	public static final String NAME = "AH";
	public static final ProtocolPack PACK = TcpipPack.of();
	public static final HeaderFactory<Ah> FACTORY = Ah::new;

	public static AhProtocol of() {
		return INSTANCE;
	}
