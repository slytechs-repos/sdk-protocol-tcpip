...
class StringTableLookup implements TableLookup {
	private final ResourceBundle defaultBundle;
	private final String tableResource;

	StringTableLookup(String tableResource) {
		this.tableResource = tableResource;
		this.defaultBundle = ResourceBundle.getBundle(tableResource);
	}
	...
	public StringTableValue lookupString(String key, Locale locale) {
		...
		try {
			...
			ResourceBundle bundle = ResourceBundle.getBundle(tableResource, locale);
