 ...
 */
public final class EthernetProtocol implements Protocol {

	private static final EthernetProtocol INSTANCE = new EthernetProtocol();
	public static final int ID = ProtocolIds.ETHERNET;
	public static final String NAME = "Ethernet";
	public static final ProtocolPack PACK = TcpipPack.of();
	public static final HeaderFactory<Ethernet> FACTORY = Ethernet::new;

	public static EthernetProtocol of() {
		return INSTANCE;
	}

	private EthernetProtocol() {}
