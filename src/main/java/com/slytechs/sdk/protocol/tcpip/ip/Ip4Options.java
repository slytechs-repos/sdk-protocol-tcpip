...
public final class Ip4Options extends BoundView
	...
	@Deprecated
	public static final int SID = 136;
	@Deprecated
	public static final int STREAM_ID = 136;
	...
	public final class Security extends Ip4Option {
		...
		public int handling() {
			return isPresent() ? buffer.getShort(offset + 5) & 0xFFFF : -1;
		}
	...
	public final class Timestamp extends Ip4Option {
		...
		public int overflow() {
			return isPresent() ? (buffer.get(offset + 3) >> 4) & 0x0F : -1;
		}

		public int flag() {
			return isPresent() ? buffer.get(offset + 3) & 0x0F : -1;
		}
		...
		public long timestamp(int index) {
			if (!isPresent() || index < 0 || index >= entryCount())
				return -1;
			int entryOff = offset + 4;
			if (flag() == TS_FLAG_TSONLY) {
				return buffer.getInt(entryOff + index * 4) & 0xFFFFFFFFL;
			} else {
				return buffer.getInt(entryOff + index * 8 + 4) & 0xFFFFFFFFL;
			}
		}
	...
	public final class Traceroute extends Ip4Option {
		...
		public int returnHops() {
			return isPresent() ? buffer.getShort(offset + 6) & 0xFFFF : -1;
		}
	...
	public boolean hasSecurityOption() {
		return security.isPresent();
	}

	public boolean hasLooseSourceRouteOption() {
		return looseSourceRoute.isPresent();
	}

	public boolean hasStrictSourceRouteOption() {
		return strictSourceRoute.isPresent();
	}

	public boolean hasSourceRouteOption() {
		return hasLooseSourceRouteOption() || hasStrictSourceRouteOption();
	}

	public boolean hasRecordRouteOption() {
		return recordRoute.isPresent();
	}

	public boolean hasTimestampOption() {
		return timestamp.isPresent();
	}

	public boolean hasRouterAlertOption() {
		return routerAlert.isPresent();
	}

	public boolean hasTracerouteOption() {
		return traceroute.isPresent();
	}
	...
	@Deprecated
	public boolean hasStreamIdOption() {
		return streamId.isPresent();
	}

	public boolean hasMtuProbeOption() {
		return mtuProbe.isPresent();
	}

	public boolean hasMtuReplyOption() {
		return mtuReply.isPresent();
	}

	public boolean hasExtendedSecurityOption() {
		return extendedSecurity.isPresent();
	}

	public boolean hasCommercialSecurityOption() {
		return commercialSecurity.isPresent();
	}

	public boolean hasAddressExtensionOption() {
		return addressExtension.isPresent();
	}

	public boolean hasSelectiveDirectedBroadcastOption() {
		return selectiveDirectedBroadcast.isPresent();
	}

	public boolean hasDynamicPacketStateOption() {
		return dynamicPacketState.isPresent();
	}

	public boolean hasUpstreamMulticastOption() {
		return upstreamMulticast.isPresent();
	}

	public boolean hasExperimentOption() {
		return experiment.isPresent();
	}

	public Security securityOption() {
		return security;
	}

	public LooseSourceRoute looseSourceRouteOption() {
		return looseSourceRoute;
	}

	public StrictSourceRoute strictSourceRouteOption() {
		return strictSourceRoute;
	}

	public RecordRoute recordRouteOption() {
		return recordRoute;
	}

	public Timestamp timestampOption() {
		return timestamp;
	}

	public RouterAlert routerAlertOption() {
		return routerAlert;
	}

	public Traceroute tracerouteOption() {
		return traceroute;
	}
	...
	@Deprecated
	public StreamId streamIdOption() {
		return streamId;
	}

	public MtuProbe mtuProbeOption() {
		return mtuProbe;
	}

	public MtuReply mtuReplyOption() {
		return mtuReply;
	}

	public ExtendedSecurity extendedSecurityOption() {
		return extendedSecurity;
	}

	public CommercialSecurity commercialSecurityOption() {
		return commercialSecurity;
	}

	public AddressExtension addressExtensionOption() {
		return addressExtension;
	}

	public SelectiveDirectedBroadcast selectiveDirectedBroadcastOption() {
		return selectiveDirectedBroadcast;
	}

	public DynamicPacketState dynamicPacketStateOption() {
		return dynamicPacketState;
	}

	public UpstreamMulticast upstreamMulticastOption() {
		return upstreamMulticast;
	}

	public ExperimentOption experimentOption() {
		return experiment;
	}
