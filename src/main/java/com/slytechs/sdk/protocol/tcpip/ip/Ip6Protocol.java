 ...
 */
public final class Ip6Protocol implements Protocol {

	private static final Ip6Protocol INSTANCE = new Ip6Protocol();
	public static final int ID = ProtocolIds.IPv6;
	public static final String NAME = "IPv6";
	public static final ProtocolPack PACK = TcpipPack.of();
	public static final HeaderFactory<Ip6> FACTORY = Ip6::new;

	public static Ip6Protocol of() {
		return INSTANCE;
	}
